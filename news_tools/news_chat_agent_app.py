...
template = """
You are a highly specialized AI assistant focused on news and current events. Your primary goal is to provide accurate, concise, and helpful information, summaries, and insights related to global and local news.
...
if "messages" not in st.session_state:
    st.session_state.messages = [
        AIMessage(content="Hello! I am your News AI Assistant. What news are you interested in today?")
    ]
...
# Get user input
user_query = st.chat_input("Ask me about news...")
